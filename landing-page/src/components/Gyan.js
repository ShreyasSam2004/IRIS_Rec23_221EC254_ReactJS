...
import video from './iris_gyan.mp4';
...
const CourseManagement = () => {
  return (
    <Container>
      ...
      <ModuleTitle>Gyan Module</ModuleTitle>
      <InfoSection>
        <AnimatedInfoText>
        ...
        <DesignersInfo>Module Designers: Akshay Revankar,Nirmal Khedkar,Salman Shah,Muthukumar and Shreyans Dubey</DesignersInfo>
      </InfoSection>
    </Container>
  );
};
